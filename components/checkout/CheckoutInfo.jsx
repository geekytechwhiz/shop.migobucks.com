...
import { getLastFourDight } from 'utils/helper';
              ...
              {address?.map((item, ind) => (
                <Grid item md={4} sm={6} xs={12} key={ind}>
                  ...
                  >
                    ...
                    <Paragraph color='grey.700'>{item.Mobile}</Paragraph>
                  </Card>
                </Grid>
              ))}
            </Grid>
            ...
            <Box>
              ...
              <Grid container spacing={3}>
                {payments && payments?.map((item) => (
                  <Grid item md={4} sm={6} xs={12} key={item.Number}>
                    <Card
                      sx={{
                        padding: 2,
                        boxShadow: 'none',
